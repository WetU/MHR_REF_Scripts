...
local MonsterDisplayDataCreated = false;
                            ...
                            if monster then
                                ...
                                if monsterType then
                                    ...
                                    if meatData and partTableData then
                                        ...
                                        if partTableData_counts and partTableData_counts > 0 then
                ...
                if TargetEnemy then
                    if savedTargetEnemy ~= TargetEnemy then
                        ...
                        if EnemyType then
                            ...
                            MonsterDisplayDataCreated = true;
                        else
                            MonsterDisplayDataCreated = false;
...
local SpiribirdsDataCreated = false;
    ...
    if BuffType == LvBuff.Rainbow then
        ...
        if count and count > 0 then
            for k, v in pairs(LvBuff) do
                if BuffType == v then
                    local newCount = AcquiredCounts[k] + count;
                    local newValue = AcquiredCounts[k] * StatusBuffAddVal[k];
                    AcquiredCounts[k] = newCount >= BirdsMaxCounts[k] and BirdsMaxCounts[k] or newCount;
                    AcquiredValues[k] = newValue >= StatusBuffLimits[k] and StatusBuffLimits[k] or newValue;
                    return sdk_CALL_ORIGINAL;
                end
            end
        end
                ...
                if EquipDataManager then
                    ...
                    if EquippingLvBuffcageData then
                        ...
                        for k, v in pairs(BuffTypes) do
                            ...
                            AcquiredCounts[k] = 0;
                            AcquiredValues[k] = 0;
                            BirdsMaxCounts[k] = math_ceil(StatusBuffLimits[k] / StatusBuffAddVal[k]);
                        end
                        SpiribirdsDataCreated = true;
                    end
                end
            end
        end
...
re_on_frame(function()
    if MonsterDisplayDataCreated then
